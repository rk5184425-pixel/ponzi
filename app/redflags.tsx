  ...
  [
    {
      ...
      isRedFlag: true,
      explanation: "No legitimate investment can guarantee high returns with zero risk."
    },
    {
      id: 2,
    ...
    },
    {
      ...
      isRedFlag: true,
      explanation: "Pressure tactics and artificial scarcity are common scam techniques."
    },
    {
      id: 4,
  ...
  [
    {
      ...
      isRedFlag: true,
      explanation: "Focus on recruitment over products is a pyramid scheme indicator."
    },
    {
      id: 6,
    ...
    },
    {
      ...
      isRedFlag: true,
      explanation: "Lack of transparency about investment methods is suspicious."
    },
    {
      id: 8,
...
const RedFlagsGame = () => {
  ...
  useEffect(() => {
    const progress = ((currentScenario * 4 + currentQuestion) / totalQuestions) * 100;
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.progressContainer}>
          ...
          <Text style={styles.progressText}>
            Question {currentScenario * 4 + currentQuestion + 1} of {totalQuestions}
          </Text>
        </View>
          ...
          <View style={styles.feedbackContainer}>
            ...
            >
              <Text style={styles.nextButtonText}>
                {currentScenario === redFlagScenarios.length - 1 && currentQuestion === 3 
                  ? "Finish Game" 
                  : "Next Question"
                }
              </Text>
